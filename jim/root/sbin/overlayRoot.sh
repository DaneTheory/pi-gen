...
mount -t vfat /dev/mmcblk0p1  /mnt/newroot/boot

NETCONF="/mnt/newroot/boot/config/network/"
if [ "$(ls -A $NETCONF 2>/dev/null)" ]; then
   cp $NETCONF/* /mnt/newroot/etc/NetworkManager/system-connections/
   chmod 0600 /mnt/newroot/etc/NetworkManager/system-connections/*
